  ...
  return (
    <section className="font-main-info pt-5 pb-15 flex flex-row sm:flex-row items-center text-sm gap-10">
      ...
      <p className="mt-2 text-xs text-[#64898E] font-side-header max-w-md text-justify">
        ...
        nulla ac scelerisque. Quisque convallis orci ac convallis venenatis.
        Nullam volutpat et nisi nec pulvinar. Pellentesque nulla tortor, auctor
        at accumsan ac, blandit ornare est. Aliquam eget faucibus tellus.
      </p>
    </section>
  );
}
